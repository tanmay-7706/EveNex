...
export default function EventDetailClient() {
  ...
  const handleRegister = () => {
    ...
    // For paid events with Stripe Connect, redirect to Stripe Checkout
    ...
    try {
      const response = await fetch('/api/stripe/checkout', {
        ...
        body: JSON.stringify({
          ...
          organizerStripeAccountId: 'placeholder', // Will be resolved from organizer's user record
        }),
      });
            ...
            >
              <CardContent className="p-6 space-y-4">
                ...
                {registration ? (
                  ...
                  <Button className="w-full gap-2" onClick={handleRegister} disabled={isStripeLoading}>
                    {isStripeLoading ? (
                      <>
                      ...
                      <>
                        <Ticket className="w-4 h-4" />
                        {event.ticketType === "paid" ? `Buy Ticket — ₹${event.ticketPrice}` : "Register for Event"}
                      </>
                    )}
                  </Button>
                )}
